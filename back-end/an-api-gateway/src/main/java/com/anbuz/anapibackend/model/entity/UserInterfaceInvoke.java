...
public class UserInterfaceInvoke implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        UserInterfaceInvoke other = (UserInterfaceInvoke) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTotalInvokes() == null ? other.getTotalInvokes() == null : this.getTotalInvokes().equals(other.getTotalInvokes()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTotalInvokes() == null) ? 0 : getTotalInvokes().hashCode());
